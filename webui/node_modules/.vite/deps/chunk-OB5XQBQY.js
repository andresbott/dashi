...
function st(t2) {
  typeof t2 == "string" ? W2(document.body, t2 || "p-overflow-hidden") : (t2 != null && t2.variableName && document.body.style.setProperty(t2.variableName, F2() + "px"), W2(document.body, (t2 == null ? void 0 : t2.className) || "p-overflow-hidden"));
}
function B2(t2) {
  if (t2) {
...
function At2(e, t2 = "") {
  return ["opacity", "z-index", "line-height", "font-weight", "flex", "flex-grow", "flex-shrink", "order"].some((s4) => t2.endsWith(s4)) ? e : `${e}`.trim().split(" ").map((a2) => z(a2) ? `${a2}px` : a2).join(" ");
}
function dt2(e) {
...
function Dt2(e = {}, t2) {
  if (a(t2)) {
    let r = t2.trim();
    return G(r, k3) ? r.replaceAll(k3, (s4) => F(e, s4.replace(/{|}/g, ""))) : r;
...
//# sourceMappingURL=chunk-OB5XQBQY.js.map
