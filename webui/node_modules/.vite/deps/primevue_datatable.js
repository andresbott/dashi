import {
  script as script15
} from "./chunk-55ILUF6H.js";
import {
  script as script12,
  script2 as script13,
  script3 as script14
} from "./chunk-2WQ7UTCC.js";
import {
  script as script11
} from "./chunk-PZVYJD2Q.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-YOJGQNJT.js";
import {
  script as script10
} from "./chunk-JH5QVYMY.js";
import {
  script as script7
} from "./chunk-3W2NAMSB.js";
import "./chunk-UE42TKIK.js";
import {
  script as script9
} from "./chunk-RP32HKWQ.js";
import "./chunk-44TSQMSI.js";
import {
  OverlayEventBus
...
import {
  ...
  _default,
  getVNodeProp
} from "./chunk-ZC2CFPIO.js";
import {
  FocusTrap
} from "./chunk-IXWCRPNN.js";
import {
  script as script8
} from "./chunk-BTC6IKXK.js";
import {
  script as script3
} from "./chunk-QZRZAFKS.js";
import {
  script as script5,
  script2 as script6
} from "./chunk-T4OM3TTB.js";
import {
  script as script4
} from "./chunk-52MAMR7N.js";
import {
  script as script2
} from "./chunk-ACFXLMLV.js";
import {
  Ripple
} from "./chunk-Y7HHMC4R.js";
import "./chunk-XHXNTSFM.js";
import "./chunk-3LX3BLXE.js";
import {
  script
} from "./chunk-WSZFP3N5.js";
import "./chunk-DAMENFZU.js";
import {
  BaseStyle
} from "./chunk-P4BTUSFZ.js";
import {
  B,
  C2 as C,
  D,
...
function _slicedToArray2(r, e) {
  return _arrayWithHoles2(r) || _iterableToArrayLimit2(r, e) || _unsupportedIterableToArray18(r, e) || _nonIterableRest2();
}
...
var script34 = {
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data13 = _toConsumableArray17(value);
    ...
    sortMultiple: function sortMultiple(value) {
      ...
      if (this.groupRowsBy && (this.d_groupRowsSortMeta || this.d_multiSortMeta.length && this.groupRowsBy === this.d_multiSortMeta[0].field)) {
        ...
        if (firstSortMeta.field !== this.d_groupRowsSortMeta.field) {
          this.d_multiSortMeta = [this.d_groupRowsSortMeta].concat(_toConsumableArray17(this.d_multiSortMeta));
        }
      }
      var data13 = _toConsumableArray17(value);
      data13.sort(function(data1, data22) {
          ...
          if (metaSelection) {
            ...
            if (selected && metaKey) {
              ...
              if (this.isSingleSelectionMode()) {
                ...
                _selection2 = [].concat(_toConsumableArray17(_selection2), [rowData]);
            ...
            if (this.selectionMode === "single") {
              ...
              if (selected) {
                ...
                var _selection4 = this.selection ? [].concat(_toConsumableArray17(this.selection), [rowData]) : [rowData];
    ...
    toggleRowWithCheckbox: function toggleRowWithCheckbox2(event) {
      ...
      if (this.isSelected(rowData)) {
        ...
        var _selection5 = this.selection ? _toConsumableArray17(this.selection) : [];
        _selection5 = [].concat(_toConsumableArray17(_selection5), [rowData]);
    ...
    toggleRowsWithCheckbox: function toggleRowsWithCheckbox(event) {
      if (this.selectAll !== null) {
        ...
        var _selection = [];
        if (checked2) {
          _selection = this.frozenValue ? [].concat(_toConsumableArray17(this.frozenValue), _toConsumableArray17(this.processedData)) : this.processedData;
    ...
    generateCSV: function generateCSV(options, data13) {
      ...
      if (!data13) {
        ...
        else if (this.frozenValue) data13 = data13 ? [].concat(_toConsumableArray17(this.frozenValue), _toConsumableArray17(data13)) : this.frozenValue;
      }
    ...
    onColumnHeaderDrop: function onColumnHeaderDrop(e) {
      ...
      if (this.draggedColumnElement) {
        ...
        if (allowDrop) {
          ...
          var reorderedWidths = [].concat(_toConsumableArray17(remainingItems.slice(0, dropColIndex)), [movedItem], _toConsumableArray17(remainingItems.slice(dropColIndex)));
    ...
    onRowDrop: function onRowDrop2(event) {
      if (this.droppedRowIndex != null) {
        ...
        var processedData2 = _toConsumableArray17(this.processedData);
    ...
    toggleRow: function toggleRow2(event) {
      ...
      if (this.dataKey) {
        ...
        expandedRows = this.expandedRows ? _toConsumableArray17(this.expandedRows) : [];
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      ...
      var _expandedRowGroups = this.expandedRowGroups ? _toConsumableArray17(this.expandedRowGroups) : [];
    ...
    onRowEditInit: function onRowEditInit3(event) {
      var _editingRows = this.editingRows ? _toConsumableArray17(this.editingRows) : [];
      _editingRows.push(event.data);
      this.$emit("update:editingRows", _editingRows);
      this.$emit("row-edit-init", event);
    },
    onRowEditSave: function onRowEditSave3(event) {
      var _editingRows = _toConsumableArray17(this.editingRows);
  ...
  computed: {
    columns: function columns() {
      ...
      if (cols && this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray17(cols.filter(function(item) {
    ...
    allRowsSelected: function allRowsSelected() {
      ...
      if (this.selectAll !== null) {
        ...
        var val = this.frozenValue ? [].concat(_toConsumableArray17(this.frozenValue), _toConsumableArray17(this.processedData)) : this.processedData;
