        ...
        nodeActions: [
          {
            ...
            action: (queryHash) => {
              var _a13;
              (_a13 = queryCache.get(queryHash)) == null ? void 0 : _a13.fetch();
            }
          },
          {
            icon: "alarm",
          ...
          },
          {
            ...
            action: (queryHash) => {
              var _a13;
              (_a13 = queryCache.get(queryHash)) == null ? void 0 : _a13.reset();
            }
          },
          {
            icon: "delete",
  ...
  install: (app, options = {}) => {
    ...
    if (options.clientPersister) {
      ...
      promise.then(() => {
        ...
        (_a13 = options.clientPersisterOnSuccess) == null ? void 0 : _a13.call(options, client);
      });
    }
    const cleanup = () => {
      client.unmount();
...
function useBaseQuery(Observer, options, queryClient) {
  ...
  const defaultedOptions = computed(() => {
    ...
    defaulted._optimisticResults = ((_a13 = client.isRestoring) == null ? void 0 : _a13.value) ? "isRestoring" : "optimistic";
    return defaulted;
  });
