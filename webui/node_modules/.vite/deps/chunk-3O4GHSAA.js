...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d2.height, a2 = d2.width, u = e.offsetHeight, p2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $(), it = k(), lt = h(), L, N3, ot = "top";
    f2.top + u + s4 > lt.height ? (L = f2.top + g3 - s4, ot = "bottom", L < 0 && (L = g3)) : L = u + f2.top + g3, f2.left + a2 > lt.width ? N3 = Math.max(0, f2.left + it + p2 - a2) : N3 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N3 + "px" : t2.style.insetInlineStart = N3 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t2, e) {
...
function I(t2, e, o = true, n = void 0) {
  var r;
  if (t2) {
    let i2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), l2 = e.offsetHeight, d2 = e.getBoundingClientRect(), s4 = h(), a2, u, p2 = n != null ? n : "top";
...
function b2(e, t2, n = /* @__PURE__ */ new WeakSet()) {
  ...
  if (o && r) {
    ...
    for (u = f2; u-- !== 0; ) if (!b2(e[u], t2[u], n)) return false;
    return true;
  }
  if (o != r) return false;
  ...
  for (u = f2; u-- !== 0; ) if (T2 = R2[u], !b2(e[T2], t2[T2], n)) return false;
  return true;
}
function y2(e, t2) {
  return b2(e, t2);
...
function Lt2(e, t2) {
  C2(e) ? e.push(...t2 || []) : i(e) && Object.assign(e, t2);
}
function ve(e) {
  return i(e) && e.hasOwnProperty("$value") && e.hasOwnProperty("$type") ? e.$value : e;
}
function At2(e, t2 = "") {
  return ["opacity", "z-index", "line-height", "font-weight", "flex", "flex-grow", "flex-shrink", "order"].some((s4) => t2.endsWith(s4)) ? e : `${e}`.trim().split(" ").map((a2) => z2(a2) ? `${a2}px` : a2).join(" ");
}
function dt2(e) {
  ...
  if (a(e)) {
    ...
    if (G2(a2, k3)) {
      let n = a2.replaceAll(k3, (l2) => {
        let c3 = l2.replace(/{|}/g, "").split(".").filter((m2) => !s4.some((d2) => G2(m2, d2)));
        return `var(${ae2(r, re(c3.join("-")))}${s2(i2) ? `, ${i2}` : ""})`;
      });
      return G2(n.replace(ie2, "0"), ne2) ? `calc(${n})` : n;
    }
    return a2;
...
function Dt2(e = {}, t2) {
  if (a(t2)) {
    let r = t2.trim();
    return G2(r, k3) ? r.replaceAll(k3, (s4) => F2(e, s4.replace(/{|}/g, ""))) : r;
  } else if (z2(t2)) return t2;
}
function Re(e, t2, r) {
...
var D2 = (e, t2, r) => {
  e = Te(e), t2 = Te(t2);
  let a2 = (r / 100 * 2 - 1 + 1) / 2, n = 1 - a2, l2 = Ne(e), o = Ne(t2), c3 = Math.round(l2.r * a2 + o.r * n), m2 = Math.round(l2.g * a2 + o.g * n), d2 = Math.round(l2.b * a2 + o.b * n);
  return gt(c3, m2, d2);
};
var ce = (e, t2) => D2("#000000", e, t2);
var me = (e, t2) => D2("#ffffff", e, t2);
...
var ue = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: i2, options: a2 } = S2.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, o = G2(t2, k3) ? t2 : `{${t2}}`;
...
var w3 = (e = {}) => {
  ...
  return { preset(s4) {
    ...
    let { semantic: i2 } = t2 || {};
    return t2 = $3(h3({}, t2), { semantic: $3(h3({}, i2), { primary: s4 }) }), this;
  }, surfacePalette(s4) {
    var o, c3;
    let { semantic: i2 } = t2 || {}, a2 = s4 && Object.hasOwn(s4, "light") ? s4.light : s4, n = s4 && Object.hasOwn(s4, "dark") ? s4.dark : s4, l2 = { colorScheme: { light: h3(h3({}, (o = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : o.light), !!a2 && { surface: a2 }), dark: h3(h3({}, (c3 = i2 == null ? void 0 : i2.colorScheme) == null ? void 0 : c3.dark), !!n && { surface: n }) } };
    return t2 = $3(h3({}, t2), { semantic: h3(h3({}, i2), l2) }), this;
    ...
    let a2 = { preset: s4 ? H(S2.getPreset(), t2) : t2, options: i2 ? h3(h3({}, S2.getOptions()), r) : r };
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g3 = m2[u], f2 = ve(g3), p2 = G2(u, a2) ? Q2(d2) : Q2(d2, re(u));
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  return Object.entries(n || {}).reduce((o, [c3, m2]) => {
    if (i(m2) && Object.hasOwn(m2, "css")) {
      let d2 = Y2(m2.css), u = `${c3}-variables`;
  ...
  let a2 = function(l2, o = {}, c3 = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      let u = G2(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m2)}` : oe(m2), g3 = c3 ? `${c3}.${m2}` : m2;
  ...
  var l2;
  let i2 = ((o) => o.split(".").filter((m2) => !G2(m2.toLowerCase(), r.variable.excludedKeyRegex)).join("."))(t2), a2 = t2.includes("colorScheme.light") ? "light" : t2.includes("colorScheme.dark") ? "dark" : void 0, n = [(l2 = e[i2]) == null ? void 0 : l2.computed(a2)].flat().filter((o) => o);
  ...
  if (s2(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c3.reduce((m2, { type: d2, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d2, t2)), m2), "") : C3(l2 != null ? l2 : ":root,:host", t2);
    }
    if (o) {
      let c3 = { name: "primeui", order: "primeui" };
      i(o) && (c3.name = m(o.name, { name: e, type: s4 })), s2(c3.name) && (t2 = C3(`@layer ${c3.name}`, t2), a2 == null || a2.layerNames(c3.name));
    }
    return t2;
  }
  return "";
...
function Le(e) {
  return w3().primaryPalette(e).update().preset;
}
function Ae(e) {
...
function je(e) {
  return w3(e).update({ mergePresets: false });
}
var ge = class {
  ...
  add(t2, r) {
    if (s2(r)) {
      ...
      this._styles.set(t2, $3(h3({}, s4), { element: this.createStyleElement(s4) }));
    }
  }
  update() {
  }
...
//# sourceMappingURL=chunk-3O4GHSAA.js.map
