...
var script3 = {
  ...
  methods: {
    ...
    onColorDragStart: function onColorDragStart(event) {
      ...
      !this.isUnstyled && W(this.$el, "p-colorpicker-dragging");
      event.preventDefault();
    },
    ...
    onDragEnd: function onDragEnd() {
      ...
      !this.isUnstyled && P(this.$el, "p-colorpicker-dragging");
      this.unbindDragListeners();
    },
    ...
    "default": withCtx(function() {
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function() {
          ...
          }, _objectSpread(_objectSpread({}, _ctx.ptm("panel")), _ctx.ptm("overlay"))), [createBaseVNode("div", mergeProps({
